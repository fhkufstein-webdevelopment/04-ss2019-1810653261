$(document).ready(function() {
    ...
    $('.needs-validation').submit(function(event) {
        ...
        ErsteSpalte.innerHTML = Liste; // Speichert Länge

        ZweiteSpalte.innerHTML = neuerNutzer; // gibt user aus

        DritteSpalte.innerHTML = "<button type=\"button\" class=\"btn btn-secondary btn-danger deleteTrigger\" title=\"Löschen\"><i class=\"fa fa-trash\"></i></button>"; // Der Deleter
